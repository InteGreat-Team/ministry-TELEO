...
class _MapScreenState extends State<MapScreen> {
              ...
              children: [
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            widget.showChurches ? 'Find prayer centers nearby' : 'Select Location',
                            style: TextStyle(
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          widget.showChurches ? 'Nearby Prayer Centers' : 'Current Location',
                        ...
                        Text(
                          widget.showChurches 
                              ? 'Select a prayer center from the map'
                ...
                Positioned(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      widget.showChurches ? 'Select This Prayer Center' : 'Use Current Location',
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 16,
                      ),
  ...
  Widget _buildChurchIcon() {
    return Container(
      ...
      child: const Center(
        child: Icon(
          Icons.person_pin, // Changed to person_pin for prayer centers
