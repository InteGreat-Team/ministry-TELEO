...
import 'dart:async';
import 'c2s9_1bsprayerrequest.dart';
...
class _SearchingScreenState extends State<SearchingScreen> {
              ...
              Expanded(
                child: Stack(
                  children: [
                    ...
                    // Church icons (placeholders) - Changed to prayer icons
                    Positioned(
                      top: 150,
                      left: 100,
                      child: _buildPrayerIcon(),
                    ),
                    Positioned(
                      top: 200,
                      right: 120,
                                    ...
                                    child: Image.asset(
                                      ...
                                      errorBuilder: (context, error, stackTrace) {
                                        return Container(
                                          ...
                                          height: 60,
                                          color: Colors.grey[300],
                                          child: const Icon(Icons.person_pin, color: Colors.grey),
                                        );
                                      },
                                    ),
                                  ),
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    // Updated to match prayer request details
                                    _buildDetailRow('Recipient Name', widget.allDetails['recipientName'] ?? 'John Doe'),
                                    _buildDetailRow('Relation to Recipient', widget.allDetails['relationToRecipient'] ?? 'Relative'),
                                    _buildDetailRow('Prayer Topic', widget.allDetails['prayerTopic'] ?? 'Personal and Spiritual Growth'),
                                    _buildDetailRow('Preferred Prayer Time', widget.allDetails['preferredPrayerTime'] ?? 'Morning'),
                                    _buildDetailRow('Privacy Option', widget.allDetails['privacyOption'] ?? 'Private'),
                                    _buildDetailRow('Purpose/Reason for Service', widget.allDetails['reasonForService'] ?? 'Seeking spiritual guidance and support.'),
                                    if (widget.allDetails['additionalInfo']?.isNotEmpty == true)
                                      _buildDetailRow('Additional Information', widget.allDetails['additionalInfo'] ?? 'No additional information provided.'),
  ...
  Widget _buildPrayerIcon() {
    return Container(
      ...
      child: const Center(
        child: Icon(
          Icons.person_pin, // Changed to person_pin for prayer providers
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                const Text(
                  'Are you sure you want to stop searching for a prayer service provider?',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 14,
                    color: Colors.grey,
