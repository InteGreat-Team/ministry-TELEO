...
import 'c2s4bshospitalsickvisit.dart';
          ...
          Expanded(
            child: Stack(
              children: [
                ...
                // Current location indicator and hospital indicators if showChurches is true
                Stack(
                  children: [
                    ...
                    // Hospital indicators (only shown if showChurches is true)
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            widget.showChurches ? 'Find hospitals nearby' : 'Select Location',
                            style: TextStyle(
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          widget.showChurches ? 'Nearby Hospitals' : 'Current Location',
                        ...
                        Text(
                          widget.showChurches 
                              ? 'Select a hospital from the map'
                ...
                Positioned(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      widget.showChurches ? 'Select This Hospital' : 'Use Current Location',
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 16,
                      ),
