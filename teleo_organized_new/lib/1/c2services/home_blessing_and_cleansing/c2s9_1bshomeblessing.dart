...
import 'c2s10bshomeblessing.dart';
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(
                          Icons.person, // Changed from church to person
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            const Text(
                              'Fr. John Smith', // Changed from church name to priest name
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 16,
                              ),
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(
                          Icons.home, // Changed from child_care to home
                          color: Color(0xFF0A0A4A),
                          size: 24,
                        ),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              allDetails['serviceType'] ?? 'Home Blessing', // Changed from Newborn to Home Blessing
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    'Your Home Address, Sample Street 12, Brgy. 222, City, 1011', // Changed to home address
                                    style: TextStyle(
                                      color: Colors.grey[700],
                                      fontSize: 12,
                                    ),
