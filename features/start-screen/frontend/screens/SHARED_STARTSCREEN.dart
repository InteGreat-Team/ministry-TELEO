...
import '../../sign-up/frontend/screens/USER_SIGNUP_1.dart' as signup; // User registration welcome
import '../../../lib/screens/login_screen.dart'; // Login
import '../../../lib/1/c1homepage/home_page.dart'; // Guest homepage
import '../../../lib/2/c1registration/c1s1churchwelcome_screen.dart'; // Church registration
import '../../../lib/2/c1homepage/home_page.dart' as admin; // Admin homepage
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const signup.UserSignUp1(),
                      ),
                    );
                  },
                  style: ElevatedButton.styleFrom(
