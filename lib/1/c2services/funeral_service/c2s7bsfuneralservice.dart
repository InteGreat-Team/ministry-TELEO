...
import 'c2s8bsfuneralservice.dart';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildInfoRow(
                          'Service Type', 
                          widget.allDetails['serviceTypes'] ?? 'Not specified',
                        ),
                        _buildInfoRow(
                          'Location', 
                          widget.allDetails['location'] ?? 'Not specified',
                        ),
                        ...
                        _buildInfoRow(
                          'Full Name', 
                          widget.allDetails['deceasedName'] ?? 'Not specified',
                        ),
                        _buildInfoRow(
                          'Date of Birth', 
                        ...
                        _buildInfoRow(
                          'Date of Passing', 
                          widget.allDetails['dateOfPassing'] ?? 'Not specified',
                        ),
                        _buildInfoRow(
                          'Cause of Death', 
                          widget.allDetails['causeOfDeath'] ?? 'Not specified',
                        ),
                        _buildInfoRow(
                          'Relation', 
                          widget.allDetails['relation'] ?? 'Not specified',
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            const Expanded(
                              child: Text(
                                'By checking this box, you hereby agree and consent to the Church Funeral Guidelines and Policies',
                                style: TextStyle(
                                  fontSize: 14,
                                  height: 1.4,
                                ),
