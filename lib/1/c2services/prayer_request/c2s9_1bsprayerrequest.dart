...
import 'c2s10bsprayerrequest.dart';
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                'We accepted your prayer request!',
                style: TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                const SizedBox(width: 4),
                                Text(
                                  'Schedule: ${allDetails['preferredDate'] ?? 'April 18, 2025'} - ${allDetails['preferredTime'] ?? '9:30 AM'}',
                                  style: TextStyle(
                                    color: Colors.grey[700],
                                    fontSize: 12,
                                  ),
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    'St. Mary\'s Prayer Center, Sample Street 12, Brgy. 222, City, 1011',
                                    style: TextStyle(
                                      color: Colors.grey[700],
                                      fontSize: 12,
                                    ),
