...
import 'dart:async';
import 'c2s9_1bsbaptismform.dart';
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    // Updated to match our changes to the service information screen
                                    _buildDetailRow('Child\'s Full Name', widget.allDetails['recipientName'] ?? 'Baby G. Dela Cruz'),
                                    _buildDetailRow('Date of Birth', widget.allDetails['dateOfBirth'] ?? '01/20/2025'),
                                    _buildDetailRow('Gender', widget.allDetails['recipientGender'] ?? 'Male'),
                                    _buildDetailRow('Type of Ceremony', widget.allDetails['serviceType'] ?? 'Infant'),
                                    _buildDetailRow('Father\'s Name', widget.allDetails['fatherName'] ?? 'John G. Dela Cruz'),
                                    _buildDetailRow('Mother\'s Name', widget.allDetails['motherName'] ?? 'Jane G. Dela Cruz'),
                                    _buildDetailRow('Purpose/Reason for Service', widget.allDetails['reasonForService'] ?? 'Our son is to be baptized into Christianity.'),
                                    if (widget.allDetails['additionalInfo']?.isNotEmpty == true)
                                      _buildDetailRow('Anything else we need to know?', widget.allDetails['additionalInfo'] ?? 'Wala naman po, I think.'),
