                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildInfoRow(
                          'Service Type', 
                          widget.allDetails['serviceType'] ?? 'Not specified',
                        ),
                        _buildInfoRow(
                          'Date of Birth', 
                          widget.allDetails['dateOfBirth'] ?? 'Not specified',
                        ),
                        ...
                        // Changed from "Recipient Information" to "Child's Information"
                        const Text(
                          'Child\'s Information',
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                        ...
                        _buildInfoRow(
                          'Gender', 
                          widget.allDetails['recipientGender'] ?? 'Not specified',
                        ),
                        // Added Father's Full Name
                        _buildInfoRow(
                          'Father\'s Name', 
                          widget.allDetails['fatherName'] ?? 'Not specified',
                        ),
                        // Added Mother's Full Name
                        _buildInfoRow(
                          'Mother\'s Name', 
                          widget.allDetails['motherName'] ?? 'Not specified',
                        ),
                        _buildInfoRow(
                          'Purpose/Reason', 
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            const Expanded(
                              child: Text(
                                'By checking this box, you hereby agree and consent to the Church Baptism Guidelines and Policies',
                                style: TextStyle(
                                  fontSize: 14,
                                  height: 1.4,
                                ),
