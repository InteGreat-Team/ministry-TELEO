                          ...
                          child: Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const Text(
                                  'Please provide details for your online ceremony',
                                  style: TextStyle(
                                    color: Colors.grey,
                                    fontSize: 16,
                                  ),
                                ...
                                const Text(
                                  'Select Application for Virtual Ceremony',
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 16,
                                  ),
                                ...
                                TextFormField(
                                  ...
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return 'Please enter your wedding date';
                                    }
                                    return null;
                                  },
                                  onTap: () async {
                                ...
                                TextFormField(
                                  ...
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return 'Please enter your ceremony time';
                                    }
                                    return null;
                                  },
                                  onTap: () async {
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () {
                                          if (_formKey.currentState!.validate()) {
                                            // Prepare virtual ceremony details
                                            final virtualCeremonyDetails = {
                                              ...
                                              'weddingDate': _preferredDateController.text,
                                              'ceremonyTime': _preferredTimeController.text,
                                            };
