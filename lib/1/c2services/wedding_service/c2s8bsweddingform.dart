...
import 'dart:async';
import 'c2s9_1bsweddingform.dart';
// Remove the import for back_button.dart
...
class _SearchingScreenState extends State<SearchingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leadingWidth: 70,
        // Removed the X button from actions
      ),
      body: Stack(
        children: [
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          widget.allDetails['serviceType'] ?? 'Wedding',
                            ...
                            // Removed the price indicator section completely
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    // Updated to match wedding details
                                    _buildDetailRow('Bride\'s Full Name', widget.allDetails['brideName'] ?? 'Jane G. Dela Cruz'),
                                    _buildDetailRow('Groom\'s Full Name', widget.allDetails['groomName'] ?? 'John G. Dela Cruz'),
                                    _buildDetailRow('Wedding Date', widget.allDetails['weddingDate'] ?? '04/18/2025'),
                                    _buildDetailRow('Type of Ceremony', widget.allDetails['serviceType'] ?? 'Traditional'),
                                    _buildDetailRow('Number of Guests', widget.allDetails['guestCount'] ?? '100'),
                                    _buildDetailRow('Reception Venue', widget.allDetails['receptionVenue'] ?? 'Same as ceremony'),
                                    _buildDetailRow('Purpose/Reason for Service', widget.allDetails['reasonForService'] ?? 'We wish to be united in holy matrimony.'),
                                    if (widget.allDetails['additionalInfo']?.isNotEmpty == true)
                                      _buildDetailRow('Anything else we need to know?', widget.allDetails['additionalInfo'] ?? 'No additional information.'),
  ...
  // Updated back to menu dialog to match the provided design
