...
import 'dart:async';
import 'c2s9_1bshomeblessing.dart';
...
class _SearchingScreenState extends State<SearchingScreen> {
              ...
              Expanded(
                child: Stack(
                  children: [
                    ...
                    // Service provider icons (changed from church icons)
                    Positioned(
                      top: 150,
                      left: 100,
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          widget.allDetails['serviceType'] ?? 'Home Blessing',
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    // Updated to match home blessing service details
                                    _buildDetailRow('Property Owner', widget.allDetails['name'] ?? 'John Dela Cruz'),
                                    _buildDetailRow('Property Address', widget.allDetails['address'] ?? 'Sample Street 12, Brgy. 222, City'),
                                    _buildDetailRow('Property Type', widget.allDetails['propertyType'] ?? 'Residential'),
                                    _buildDetailRow('Service Type', widget.allDetails['serviceType'] ?? 'Home Blessing'),
                                    _buildDetailRow('Purpose/Reason for Service', widget.allDetails['reasonForService'] ?? 'New home blessing and cleansing.'),
  ...
  Widget _buildServiceProviderIcon() {
    return Container(
      ...
      child: const Center(
        child: Icon(
          Icons.person, // Changed from church to person icon
