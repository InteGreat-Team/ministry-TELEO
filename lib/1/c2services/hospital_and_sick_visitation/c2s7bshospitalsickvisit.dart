...
import 'c2s8bshospitalsickvisit.dart';
...
class _SummaryScreenState extends State<SummaryScreen> {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildInfoRow(
                          'Prayer Session Type', 
                          widget.allDetails['prayerSessionType'] ?? 'Private',
                        ),
                        ...
                        // Changed from "Child's Information" to "Sick Person's Information"
                        const Text(
                        ...
                        _buildInfoRow(
                          'Full Name', 
                          widget.allDetails['sickPersonName'] ?? 'Not specified',
                        ),
                        _buildInfoRow(
                          'Age', 
                          widget.allDetails['sickPersonAge'] ?? 'Not specified',
                        ),
                        _buildInfoRow(
                          'Relation to Sick Person', 
                          widget.allDetails['relationToSickPerson'] ?? 'Not specified',
                        ),
                        _buildInfoRow(
                          'Purpose/Reason', 
                        ...
                        // Terms and conditions - Updated to be toggleable and properly aligned
                        Row(
                          ...
                          children: [
                            ...
                            const Expanded(
                              child: Text(
                                'By checking this box, you hereby agree and consent to the Hospital Visitation Guidelines and Policies',
                                style: TextStyle(
                                  fontSize: 14,
                                  height: 1.4,
                                ),
  ...
  // This is the connection point between c2s7 and c2s8
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                const Text(
                  'Are you sure you want to begin finding a service provider?',
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.of(context).pop();
                          // This is where we navigate to c2s8bshospitalsickvisit.dart
                          Navigator.push(
                            context,
                            MaterialPageRoute(
