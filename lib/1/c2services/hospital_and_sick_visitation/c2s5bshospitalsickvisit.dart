...
import 'c2s6bshospitalsickvisit.dart';
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Full Name of Sick Person
                      RichText(
                        text: const TextSpan(
                          children: [
                            TextSpan(
                              text: 'Full Name of Sick Person ',
                              style: TextStyle(
                                fontWeight: FontWeight.w500,
                                fontSize: 14,
                                color: Colors.black87,
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'Please enter the sick person\'s name';
                          }
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'Please enter the sick person\'s age';
                          }
                          return null;
                        },
                        inputFormatters: [
                      ...
                      Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            ...
                            items: ['Relative', 'Friend', 'Spouse', 'Parent', 'Child', 'Sibling', 'Other']
                                .map((String value) {
                      ...
                      // Prayer Session Type - Added red asterisk
                      RichText(
                        text: const TextSpan(
                          children: [
                            TextSpan(
                              text: 'Does the sick person want a private or group prayer session? ',
                              style: TextStyle(
                                fontWeight: FontWeight.w500,
                                fontSize: 14,
                                color: Colors.black87,
                      ...
                      // Radio buttons for prayer session type
                      RadioListTile<String>(
                        title: const Text('Private prayer'),
                        value: 'Private',
                        groupValue: _prayerSessionType,
                        activeColor: const Color(0xFF0A0A4A),
                        contentPadding: EdgeInsets.zero,
                        dense: true,
                        onChanged: (value) {
                          setState(() {
                            _prayerSessionType = value;
                          });
                        },
                      ),
                      RadioListTile<String>(
                        title: const Text('Group session at the church'),
                        value: 'Group',
                        groupValue: _prayerSessionType,
                        activeColor: const Color(0xFF0A0A4A),
                        contentPadding: EdgeInsets.zero,
                      ...
                      // Reason/Purpose of Service - Added red asterisk
                      RichText(
                        text: const TextSpan(
                          children: [
                            TextSpan(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ElevatedButton(
                              onPressed: () {
                                if (_formKey.currentState!.validate() && _prayerSessionType != null) {
                                  // Combine personal details with service details
                                  final allDetails = {
                                    ...widget.personalDetails,
                                    'sickPersonName': _nameController.text,
                                    'sickPersonAge': _ageController.text,
                                    'relationToSickPerson': selectedRelation,
                                    'prayerSessionType': _prayerSessionType!,
                                ...
                                } else if (_prayerSessionType == null) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text('Please select a prayer session type'),
                                    ),
                                  );
                                }
                              },
