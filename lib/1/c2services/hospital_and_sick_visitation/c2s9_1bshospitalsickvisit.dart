...
import 'c2s10bshospitalsickvisit.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leadingWidth: 70,
        // Removed the X button from the actions
      ),
      body: SingleChildScrollView(
        child: Column(
          children: [
            // Map indicator with custom map icon (without gray bar)
            Container(
              height: 220,
              ...
              child: Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: const Color(0xFF0A4A8F).withOpacity(0.15), // Changed to blue with opacity
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    '32 Hospital Drive, Quezon City, Manila, 1011',
                                    style: TextStyle(
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        height: 50,
                        decoration: BoxDecoration(
                          color: const Color(0xFF0A0A4A).withOpacity(0.1), // Navy blue with low opacity
                          borderRadius: BorderRadius.circular(8),
                        ),
                        child: const Icon(
                          Icons.healing,
                          color: Color(0xFF0A0A4A), // Navy blue
                          size: 24,
                        ),
                      ),
                      const SizedBox(width: 16),
            ...
            // Action buttons (removed payment button, only kept Back)
            Padding(
              padding: const EdgeInsets.all(16),
              child: Column(
                children: [
...
// Custom painter for the map icon without the gray bar
class MapIconPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    final Paint paint = Paint()
      ..color = const Color(0xFF0A4A8F).withOpacity(0.6) // Changed to blue with opacity
      ..style = PaintingStyle.fill;

    // Draw the map shape (without the horizontal gray bar)
    ...
    final Paint bluePaint = Paint()
      ..color = const Color(0xFF0A0A4A) // Navy blue
      ..style = PaintingStyle.fill;
