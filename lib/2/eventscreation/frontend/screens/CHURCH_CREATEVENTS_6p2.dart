...
import '../../frontend/screens/CHURCH_CREATEEVENTS_8p2.dart';
...
class _EventInviteScreenState extends State<EventInviteScreen> {
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Capacity Summary
                          _buildCapacitySummary(totalInvited, remainingCapacity, isCapacityReached),
                          const SizedBox(height: 24),
          ...
          child: Column(
            children: [
              ...
              RadioListTile<String>(
                ...
                subtitle: const Text('Invite specific churches and individuals'),
  ...
  Widget _buildChurchSelectionSection(List<Map<String, dynamic>> filteredChurches) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
      ...
      child: Column(
        ...
        children: [
          ...
          ...roleCount.entries.map((entry) {
            ...
            final currentCount = _viewModel.model.selectedRolesCounts[role] ?? 0;
                      ...
                      children: [
                        IconButton(
                          onPressed: currentCount > 0 
                            ? () => _viewModel.updateRoleCount(role, currentCount - 1)
                            : null,
        ...
        Row(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              icon: Icon(_viewModel.model.showGuestForm ? Icons.close : Icons.add),
              label: Text(_viewModel.model.showGuestForm ? 'Cancel' : 'Add Guest'),
  ...
  Widget _buildCapacitySummary(int totalInvited, int remainingCapacity, bool isCapacityReached) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
  ...
  Widget _buildNotification() {
    if (!_viewModel.model.showNotification || _viewModel.model.notificationMessage == null) {
        ...
        children: [
          ...
          Expanded(
            child: ElevatedButton(
              onPressed: () => _viewModel.proceedToNext(context, widget.event, _formKey),
              style: ElevatedButton.styleFrom(
                backgroundColor: _viewModel.model.navyBlue,
                foregroundColor: Colors.white,
                padding: const EdgeInsets.symmetric(vertical: 16),
