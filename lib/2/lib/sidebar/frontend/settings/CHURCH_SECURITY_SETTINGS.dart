        ...
        builder: (context, viewModel, child) {
          final List<_SecuritySettingItem> _securitySettingsItems = [
            _SecuritySettingItem(
              ...
              onTap: () => viewModel._onNavigate(AdminView.changeEmail),
            ),
            _SecuritySettingItem(
              icon: Icons.lock_outline,
              title: 'Change Password',
              subtitle: 'Change your account password',
              onTap: () => viewModel._onNavigate(AdminView.changePassword),
            ),
            _SecuritySettingItem(
              icon: Icons.phone_outlined,
              title: 'Change Phone Number',
              subtitle: 'Change your account phone number',
              onTap: () => viewModel._onNavigate(AdminView.changePhone),
            ),
            _SecuritySettingItem(
              icon: Icons.security,
              title: 'Authenticator App',
              subtitle: 'Set up two-factor authentication',
              onTap: () => viewModel._onNavigate(AdminView.authenticator),
            ),
          ];
