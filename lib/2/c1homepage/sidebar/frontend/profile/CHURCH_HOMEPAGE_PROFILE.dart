...
import '../../../sidebar/backend/church_homepage_viewmodel.dart';
...
class ChurchHomepageProfile extends StatelessWidget {
  ...
  final Function(AdminData)
      onUpdateAdminData; // Callback to update parent ViewModel
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _buildStatItem('Posts', adminData.posts.length.toString()),
                _buildStatItem('Following', adminData.following.toString()),
                _buildStatItem('Followers', adminData.followers.toString()),
              ],
            ),
          ],
        ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildInfoItem(Icons.email, 'Email', adminData.currentEmail),
            const SizedBox(height: 12),
            _buildInfoItem(Icons.phone, 'Phone', adminData.currentPhoneNumber),
          ],
        ),
      ),
    );
...
class ChurchProfileViewModel extends ChangeNotifier {
  ...
  ChurchProfileViewModel({required AdminData adminData})
