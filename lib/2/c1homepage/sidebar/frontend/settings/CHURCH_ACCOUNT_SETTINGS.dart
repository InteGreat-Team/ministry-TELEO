        ...
        child: SafeArea(
          child: ChangeNotifierProvider(
            create: (context) => ChurchSettingsViewModel(
              adminData: adminData,
              onNavigate: (view,
                  {flow, newValue}) {}, // Placeholder for onNavigate
            ),
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                ...
                                Text(
                                  viewModel.churchNameController.text,
                            ...
                            _buildEditableField(
                              'Church Name',
                              viewModel.churchNameController,
                              viewModel.isEditing,
                            ),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      _buildDonationField(
                                        'Gcash',
                                        viewModel.gcashController,
                                        viewModel.isEditing,
                                      ),
                                      _buildDonationField(
                                        'Maya',
                                        viewModel.mayaController,
                                        viewModel.isEditing,
                                      ),
                                      _buildDonationField(
                                        'BDO',
                                        viewModel.bdoController,
                                        viewModel.isEditing,
                                      ),
                                      _buildDonationField(
                                        'BPI',
                                        viewModel.bpiController,
                                        viewModel.isEditing,
                                      ),
                                    ],
                                  ),
