// lib/sidebar/frontend/faqs_screen/CHURCH_FAQS_SCREEN.dart

import 'package:flutter/material.dart';
import '../../../models/admin_models.dart';

class CHURCH_FAQS_SCREEN extends StatefulWidget {
  final Function(AdminView) onNavigate;
  const CHURCH_FAQS_SCREEN({super.key, required this.onNavigate});
  @override
  State<CHURCH_FAQS_SCREEN> createState() => _CHURCH_FAQS_SCREENState();
}

class _CHURCH_FAQS_SCREENState extends State<CHURCH_FAQS_SCREEN> {
        ...
        FaqCategory(
          ...
          questions: [
            ...
            FaqItem(
              ...
              expandedValue:
                  'Yes, you can register through the church\'s page.',
            ),
            FaqItem(
            ...
            FaqItem(
              ...
              expandedValue:
                  'You can update your profile from the settings menu.',
            ),
            FaqItem(
  ...
  Widget _buildFaqList() {
    ...
    final filteredCategories = faqCategories
        .map((category) {
          if (_searchQuery.isEmpty) return category;
          final filteredQuestions = category.questions.where((item) {
        ...
        .toList();
    return Column(
      children: filteredCategories.map((FaqCategory category) {
        return Column(
          children: [
