      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Acknowledgment Section (moved from footer)
            Container(
              padding: const EdgeInsets.all(20),
              decoration: BoxDecoration(
                  ...
                  Column(
                    children: [
                      ...
                      _buildSectionItem(
                        number: '8',
                        title: 'Disclaimers',
                        content: 'Teleo is provided "AS IS" and "AS AVAILABLE" without warranties of any kind. We do not guarantee:\n\n• Continuous, uninterrupted access.\n• That the App will be error-free, secure, or virus-free.\n• That any content will be reliable or accurate.\n\nTo the fullest extent permitted by law, we disclaim all express and implied warranties.',
                      ),
                      _buildDivider(),
                      _buildSectionItem(
                        number: '9',
                        title: 'Limitation of Liability',
                        content: 'To the extent permitted by law, minIStry shall not be liable for any indirect, incidental, consequential, or punitive damages arising from:\n\n• Use or inability to use the App.\n• Unauthorized access or alterations to your data.\n• Conduct or content of any user or third party.\n\nOur total liability for all claims shall not exceed PHP 1,000.',
                      ),
                      _buildDivider(),
                      _buildSectionItem(
                        number: '10',
                        title: 'Indemnification',
                        content: 'You agree to indemnify and hold harmless minIStry, its officers, affiliates, and employees from any claims, damages, obligations, losses, or expenses (including legal fees) arising from:\n\n• Your use or misuse of the App.\n• Your violation of these Terms.\n• Your infringement of any rights of another party.',
                      ),
                      _buildDivider(),
                      _buildSectionItem(
                        number: '11',
                        title: 'Changes to These Terms',
                        content: 'We may update these Terms at any time. When we do, we will revise the Effective Date and notify you through the App or via email. Continued use of the App after such changes implies acceptance of the updated Terms.',
                      ),
                      _buildDivider(),
                      _buildSectionItem(
                        number: '12',
                        title: 'Governing Law',
                        content: 'These Terms are governed by the laws of the Republic of the Philippines, without regard to conflict of law principles. Any disputes shall be resolved in the courts of [Insert City, e.g., Quezon City, Metro Manila].',
                      ),
                      _buildDivider(),
                      _buildSectionItem(
                        number: '13',
