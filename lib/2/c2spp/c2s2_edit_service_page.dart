...
import '../../2/utils/time_slot_generator.dart';
...
class _EditServicePageState extends State<EditServicePage> {
  ...
  // Time slots
  late final List<String> _allTimeSlots;
  ...
  void initState() {
    ...
    _allTimeSlots = TimeSlotGenerator.generateTimeSlots(
      startTime: DateTime(2023, 1, 1, 9, 0),
      endTime: DateTime(2023, 1, 1, 21, 30),
      intervalMinutes: 30,
    );
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              DottedBorder(
                // TODO: Add border options if upgrading dotted_border package
                child: Container(
                    ...
                    Theme(
                      data: ThemeData(
                        checkboxTheme: CheckboxThemeData(
                          ...
                          fillColor: MaterialStateProperty.resolveWith<Color>((
                            ...
                            return Colors.grey.shade300; // Gray when unchecked
                          }),
                      ...
                      child: Column(
                        children: [
                          ...
                          CheckboxListTile(
                            title: const Text('Scheduled for Later Booking'),
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          onTap: () async {
                            ...
                            if (_toTheChurch) modeList.add('church_location');
                            if (_toYourLocation) modeList.add('user_location');
                            ...
                            try {
                              ...
                              if (_imageBytes != null) {
                                ...
                                // final uploader = S3UploadService(); // TODO: Implement S3UploadService or provide correct import
