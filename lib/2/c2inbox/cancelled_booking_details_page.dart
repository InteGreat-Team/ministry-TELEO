...
class CancelledBookingDetailsPage extends StatefulWidget {
  ...
  const CancelledBookingDetailsPage({
    ...
    this.cancelledBy = 'Service Booker',
  });

  @override
  State<CancelledBookingDetailsPage> createState() => _CancelledBookingDetailsPageState();
}

class _CancelledBookingDetailsPageState extends State<CancelledBookingDetailsPage> {
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // Divider after Cancellation Details
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 8.0),
              child: Divider(color: Colors.grey.shade300),
            ),

            // Booking Details section (simplified)
            Padding(
