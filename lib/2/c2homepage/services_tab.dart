...
import '../widgets/service_request_card.cart.dart' as widget_card;
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
              ...
              TextButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ServicePortfolioPage(),
                    ),
                  );
                },
          ...
          // Service Portfolio Cards - Horizontal Scroll
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                // Add more ServicePortfolioCard instances as needed
              ],
            ),
          ),
          ...
          widget_card.ServiceRequestCard(
