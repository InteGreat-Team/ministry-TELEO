            ...
            builder: (context, viewModel, child) {
              return Column(
                ...
                children: [
                  ...
                  // First Name field
                  TextField(
                    controller: viewModel.firstNameController, // Use ViewModel's controller
                    ...
                    onChanged: viewModel.setFirstName, // Explicitly call ViewModel setter
                  ),
                  const SizedBox(height: 16),
                  // Last Name field
                  TextField(
                    controller: viewModel.lastNameController, // Use ViewModel's controller
                    decoration: InputDecoration(
                      hintText: 'Last Name',
                      hintStyle: TextStyle(color: Colors.grey.shade400),
                      contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 16),
                    ...
                    onChanged: viewModel.setLastName, // Explicitly call ViewModel setter
                  ),
                  const Spacer(),
                  // Next button
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: viewModel.isNameInputValid // Corrected to use the new getter
